...
export const sleeperRostersTimeoutMs = 10_000
export const sleeperRostersMaximumBytes = 5_000_000
...
export async function fetchSleeperLeagueRosters(
  ...
  return sleeperGetJsonWithMetadata(["league", externalLeagueId, "rosters"], {
    ...options,
    timeoutMs: sleeperRostersTimeoutMs,
    maxResponseBytes: sleeperRostersMaximumBytes,
  })
}
